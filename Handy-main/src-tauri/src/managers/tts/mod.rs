...
use crate::overlay::{hide_speaking_overlay, show_speaking_overlay, show_tts_processing_overlay};
...
impl TTSManager {
    ...
    pub fn speak(&self, text: String, request_id: u64) {
        ...
        thread::spawn(move || {
            ...
            show_tts_processing_overlay(&app_handle);
            ...
            while next_chunk_to_append < total_chunks {
                ...
                while let Some(chunk_result) = pending_results.remove(&next_chunk_to_append) {
                    ...
                    if !started_playback {
                        ...
                        audio_feedback::play_feedback_sound(&app_handle, audio_feedback::SoundType::Start);
                        shared_sink.play();
                ...
                && active_request.load(Ordering::SeqCst) == request_id
            {
                ...
                audio_feedback::play_feedback_sound(&app_handle, audio_feedback::SoundType::Stop);
                info!(
