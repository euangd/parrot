...
async getTtsModelStatus() : Promise<TtsModelStatus> {
    return await TAURI_INVOKE("get_tts_model_status");
},
...
async resizeTtsOverlay(contentHeight: number) : Promise<void> {
    await TAURI_INVOKE("resize_tts_overlay", { contentHeight });
},
...
export type TtsModelStatus = { is_loaded: boolean; is_loading: boolean }
