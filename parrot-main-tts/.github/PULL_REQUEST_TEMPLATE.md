...
- [ ] I have searched [existing issues](https://github.com/rishiskhare/parrot/issues) and [pull requests](https://github.com/rishiskhare/parrot/pulls) (including closed ones) to ensure this isn't a duplicate
- [ ] I have read [CONTRIBUTING.md](https://github.com/rishiskhare/parrot/blob/main/CONTRIBUTING.md)
